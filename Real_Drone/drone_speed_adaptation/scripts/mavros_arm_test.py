...
f = open(r"/home/odroid/catkin_ws/src/vision_to_mavros/scripts/Result_Record/mavros_arm_test.txt","w")
...
def simple_demo():
    ...
    for i in range (1, 150):
        ...
        pitch = euler[1]
        yaw = euler[2]
        print("count: %d\t px: %f\t py: %f\t pz: %f\t roll: %f\t pitch: %f\t yaw: %f\t vx: %f\t vy: %f\t vz: %f\n" % (i,px,py,pz,roll,pitch,yaw,c.vx,c.vy,c.vz))
        f.write("%f\t %f\t %f\t %f\t %f\t %f\t %f\t %f\t %f\n" % (px,py,pz,roll,pitch,yaw,c.vx,c.vy,c.vz))
        rospy.sleep(0.1)
